...
class NotesListVewController: UIViewController, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // anditd delete action
        if let vc = segue.destination as? NoteDetailsViewContoller {
            if let indexPath = tableView.indexPathForSelectedRow {
    ...
    extension NotesListViewController:NSFetchedResultsControllerDelegate {
        ...
        func controller(_ controller:NSFetchedResultsController<NSFetcRequestResult>, didchange anyObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
            switch type {
            case .insert:
        ...
        func controllerDidChangeContent(_ controller: NSFetchedResultsController<NSFetchedRequestResult>) {
